...
export const INDUSTRIES: Industry[] = [
  ...
  {
    id: 'fintech',
    label: { en: 'Fintech / Financial Services', es: 'Fintech / Servicios financieros' },
  },
  { id: 'ecommerce', label: { en: 'E-commerce / Retail', es: 'E-commerce / Retail' } },
  {
    id: 'agency-marketing',
    label: { en: 'Agency / Marketing Services', es: 'Agencia / Servicios de marketing' },
  },
  {
    id: 'media-content',
    label: { en: 'Media / Content / Publishing', es: 'Medios / Contenido / Editorial' },
  },
  ...
  { id: 'real-estate', label: { en: 'Real Estate / Proptech', es: 'Bienes Raíces / Proptech' } },
  {
    ...
    label: { en: 'Logistics / Transportation', es: 'Logística / Transporte' },
  },
  ...
  { id: 'energy', label: { en: 'Energy / Utilities', es: 'Energía / Servicios públicos' } },
  {
    ...
    label: {
      ...
      es: 'Consultoría / Servicios profesionales',
    },
  },
  ...
  {
    id: 'travel-tourism',
    label: { en: 'Travel / Tourism / Hospitality', es: 'Viajes / Turismo / Hospitalidad' },
  },
  { id: 'nonprofit-ngo', label: { en: 'Nonprofit / NGO', es: 'Sin fines de lucro / ONG' } },
  {
    id: 'government-public',
    label: { en: 'Government / Public Sector', es: 'Gobierno / Sector público' },
  },
