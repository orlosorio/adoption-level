  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="w-full max-w-[520px] text-center">
        <h2 className="font-sans text-xl font-bold text-[#1f36a9] sm:text-2xl">
          {copy.heading}
        </h2>
        <p className="mt-3 font-sans text-[15px] font-semibold text-[#1f36a9]/70">
          {copy.sub1}
        </p>
        ...
        <div className="mt-6 space-y-2.5 sm:mt-8">
          <div className="vprop-card">
            <span className="vprop-icon" aria-hidden>📧</span>
            <div>
        ...
        <button
          type="button"
          onClick={onContinue}
          className="vprop-cta mt-6 sm:mt-8"
        >
          {copy.cta}
        </button>
        ...
        <button
          type="button"
          onClick={onSkip}
          className="vprop-skip mt-4"
        >
          {copy.skip}
        </button>

        <p className="vprop-live-counter mt-4">
          {copy.liveCounter(1247)}
        </p>
      </div>
    </div>
  );
